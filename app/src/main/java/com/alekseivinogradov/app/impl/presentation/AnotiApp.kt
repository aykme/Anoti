...
class AnotiApp : Application() {
    ...
    private val coroutineContextProvider: CoroutineContextProvider
            by lazy(LazyThreadSafetyMode.NONE) { CoroutineContextProviderPlatform(context = this) }


    private val animeDatabase: AnimeDatabase
            by lazy(LazyThreadSafetyMode.NONE) { AnimeDatabase.getDatabase(context = this) }
    ...
    private fun setupWorkManager() {
        ...
        WorkManager.getInstance(/* context = */ this)
            .enqueueUniquePeriodicWork(
                /* uniqueWorkName = */ AnimeUpdateWorker.animeUpdateWorkName,
