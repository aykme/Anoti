...
class OngoingSectionReducerImplTest {

    private val reducer = OngoingSectionReducerImpl()
    ...
    private val baseState = OngoingSectionStore.State(
    ...
    private fun reduce(msg: OngoingSectionStore.Message): OngoingSectionStore.State {
    ...
    fun changeContentTypeReplacesOnlyTheContentType() {
        //Given
        val msg = OngoingSectionStore.Message.ChangeContentType(ContentTypeDomain.ERROR)
    ...
    fun updateListItemsReplacesOnlyTheListItems() {
        //Given
        val msg = OngoingSectionStore.Message.UpdateListItems(incomingItems)
    ...
    fun updateEnabledExtraEpisodesInfoIdsReplacesOnlyThatSet() {
        //Given
        val msg = OngoingSectionStore.Message.UpdateEnabledExtraEpisodesInfoIds(setOf(INCOMING_ID))
    ...
    fun updateAnimeDetailsReplacesOnlyTheAnimeDetails() {
        //Given
        val msg = OngoingSectionStore.Message.UpdateAnimeDetails(incomingDetails)
    ...
    fun restoreSectionSeedsTheDisplayStateAndTheRestoreTargetWithoutTouchingTheItems() {
        //Given
        val msg = OngoingSectionStore.Message.RestoreSection(
    ...
    fun clearRestoreTargetItemCountClearsOnlyTheRestoreTarget() {
        //Given
        val msg = OngoingSectionStore.Message.ClearRestoreTargetItemCount
