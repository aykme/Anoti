 ...
 * `Activity` reference. Implemented by the Activity hosting [AnimeListFragment]; the fragment
 * reads [animeListScreenComponent] through this interface instead of depending on the concrete
