...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // anime id, the fake service's desired result, the http client and the scope
            // annotation its binding carries, the public string resources, and the refresh box
            // with its modifier and its content's scope.
