...
4. The local database is implemented via [Room](https://developer.android.com/training/data-storage/room). I plan try to replace it with [Realm Kotlin](https://github.com/realm/realm-kotlin) in the future for KMP supporting.
...
9. [Kotlin Tests](https://kotlinlang.org/api/core/kotlin-test) library is used for Unit testing of KMP modules. I used a "Fakes" approach, but I try to find a good KMP mock library in the future.
