 ...
 * `@ContributesTo` in the same source set as [DiAppComponent]'s `@MergeComponent`, KSP silently
 ...
 * maintenance mode, so this stays until [DiAppComponent] contributes something of its own, or the
